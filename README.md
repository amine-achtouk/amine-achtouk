...
<p align="left">
  <img src="https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,react,express,nodejs,mongodb,postman,mysql,git,github,bash,linux&theme=dark" />
  <img src="https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/rocket.svg" width="48" height="48" style="vertical-align: top; background-color: #1a1a1a; padding: 5px; border-radius: 10px;" />
</p>
